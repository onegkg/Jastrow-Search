...
function SenseDisplay({ sense }: { sense: Sense }) {
	return (
		...
		>
			...
			{sense.definition ? <SanitizedHtml html={sense.definition} /> : null}

			{sense.note && (
				<div style={{ marginTop: "0.25rem", fontSize: "0.9em", color: "#bbb" }}>
					Note: <SanitizedHtml html={sense.note} />
				</div>
			)}

			{sense.notes && (
				<div style={{ marginTop: "0.25rem", fontSize: "0.9em", color: "#bbb" }}>
					<SanitizedHtml html={sense.notes} />
				</div>
			)}
	...
	return (
		...
		>
			...
			{entry.notes && (
				...
				>
					<strong>Notes:</strong> <SanitizedHtml html={entry.notes} />
				</div>
			)}
			...
			{entry.derivatives && (
				<div style={{ marginTop: "0.75rem", fontSize: "0.9em" }}>
					...
					<SanitizedHtml html={entry.derivatives} />
				</div>
			)}
